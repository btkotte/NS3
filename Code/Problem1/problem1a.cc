...
int main(int argc, char *argv[]) {
    ...
    //UDP flow:  B->b (b: UDP Server, B: UDP Client)
    ...
    wifiPhy.EnablePcap("1a_node_A", node_A.Get(0)->GetId(), 0);
    wifiPhy.EnablePcap("1a_node_a", node_a.Get(0)->GetId(), 0);
    wifiPhy.EnablePcap("1a_node_B", node_B.Get(0)->GetId(), 0);
    wifiPhy.EnablePcap("1a_node_b", node_b.Get(0)->GetId(), 0);
